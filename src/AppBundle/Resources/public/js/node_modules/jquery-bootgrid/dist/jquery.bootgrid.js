    ...
    Grid.prototype.select = function(rowIds)
    {
        if (this.selection)
        {
            ...
            while (rowIds.length > 0 && !(!this.options.multiSelect && selectedRows.length === 1))
            {
                ...
                if ($.inArray(id, this.selectedRows) === -1)
                {
                    for (i = 0; i < this.currentRows.length; i++)
                    {
                        ...
                        {
                            this.currentRows[i].id =parseInt(this.currentRows[i].id);

                            selectedRows.push(this.currentRows[i]);
                            this.selectedRows.push(parseInt(id));
                            break;
                        }
                    }
                }
            ...
            if (selectedRows.length > 0)
            {
                ...
                {
                    selectMultiSelectBox = ($.inArray(parseInt(this.currentRows[i++][this.identifier]), this.selectedRows) !== -1);
                }
    ...
    Grid.prototype.deselect = function(rowIds)
    {
        if (this.selection)
        {
            ...
            while (rowIds.length > 0)
            {
                ...
                var _index = 0;
                $.each(this.selectedRows, function( index, value ) {
                    if(value == id) {
                        _index = index;
                    }
                });
