...
class FosUserGroup
{
     ...
     * Add user
     *
     * @param \AppBundle\Entity\FosUserUser $user
     * @return FosUserGroup
     */
    public function addUser(\AppBundle\Entity\FosUserUser $user)
    {
        $this->user[] = $user;
     ...
     * @param \AppBundle\Entity\FosUserUser $user
     */
    public function removeUser(\AppBundle\Entity\FosUserUser $user)
    {
